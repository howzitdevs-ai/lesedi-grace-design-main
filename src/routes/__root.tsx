...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Affordable, dignified funeral cover for local families from R31/month, up to R50,000. Authorised FSP 9027. 24/7 emergency assistance. Get an instant quote today." },
      ...
      { property: "og:title", content: "Lesedi Funeral Society — Dignified Funeral Cover in the North West" },
      ...
      { name: "twitter:description", content: "Affordable funeral cover from R31/month for local families. 24/7 assistance. FSP 9027." },
